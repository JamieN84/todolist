...
// The remove and complete icons in SVG format for ease of code read
...
// If the 'Item' field is not empty, add text to to-do list
...
// Removes and item from the To-Do List
function removeItem() {
